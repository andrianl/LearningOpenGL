...
newoption {
    trigger = "use_clang",
    description = "Enable the use of the Clang toolset for building the project, if available. Clang is a highly optimized compiler for C/C++ languages, known for its fast compilation and modern features."
}
...
defines {"GLEW_STATIC", "GLM_FORCE_INTRINSICS", "GLM_FORCE_SWIZZLE", "GLM_EXT_INCLUDED"} -- Preprocessor definitions for all projects
...
files {thirdPartyDir .. "GLFW/include/GLFW/*.h", thirdPartyDir .. "GLFW/src/*.c"}

includedirs {thirdPartyDir .. "GLFW/include"}
...
files {thirdPartyDir .. "GLEW/include/GL/**.h", thirdPartyDir .. "GLEW/src/**.c"}

includedirs {thirdPartyDir .. "GLEW/include"}
...
files {thirdPartyDir .. "imgui/include/**.h", thirdPartyDir .. "imgui/include/**.cpp"}

includedirs {thirdPartyDir .. "imgui/include", thirdPartyDir .. "GLFW/include", thirdPartyDir .. "GLEW/include"}
...
files {thirdPartyDir .. "glm/glm/**.hpp", thirdPartyDir .. "glm/glm/**.inl"}

includedirs {thirdPartyDir .. "glm"}
...
files {applicationDir .. "Include/**.h", applicationDir .. "Source/**.cpp", applicationDir .. "Resources/**"}

includedirs {applicationDir .. "Include", thirdPartyDir .. "GLFW/include", thirdPartyDir .. "GLEW/include",
             thirdPartyDir .. "imgui/include", thirdPartyDir .. "glm"}

links {"GLFW", "GLEW", "imgui"}

libdirs {targetDir .. "GLFW", targetDir .. "GLEW", targetDir .. "imgui"}
